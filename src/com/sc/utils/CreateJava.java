...
public class CreateJava {
	...
	private static String passWord = res.getString("gpt.password");
	 ...
	 //项目跟路径路径，此处修改为你的项目路径F:\PDC\ProjectEnv\StemCell\StemCell
	private static String rootPath = "F:\\PDC\\ProjectEnv\\StemCell\\StemCell\\";//getRootPath();// "F:\\openwork\\open\\";
	private static String actionPath = "F:\\PDC\\ProjectEnv\\StemCell\\StemCell\\src\\com\\sc\\";
	...
	public static void main(String[] args) {
		 ...
		 //包路径
		 String pckPath = rootPath + "src\\com\\sc\\";
...
//			attrMap.clear();
			attrMap.put("resource","com/sc/mybatis/"+className+"Mapper.xml");
